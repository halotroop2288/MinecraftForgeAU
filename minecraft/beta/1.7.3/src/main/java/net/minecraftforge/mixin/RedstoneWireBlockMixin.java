...
public abstract class RedstoneWireBlockMixin {
	 ...
	 */
	@Inject(method = "shouldConnectTo", cancellable = true,
		at = @At(value = "INVOKE", target = "Lnet/minecraft/block/Block;isSignalSource()Z"))
	private static void forge$isPowerProviderOrWire_canProvidePower(WorldView world, int x, int y, int z, int direction,
