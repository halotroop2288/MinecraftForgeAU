...
/**
 * This interface is to be implemented by {@link net.minecraft.block.Block} classes.
...
public interface IConnectRedstone {
	 ...
	 * @since 1.0.0
	 */
	boolean canConnectRedstone(@NotNull WorldView world, int x, int y, int z, int direction);
}
