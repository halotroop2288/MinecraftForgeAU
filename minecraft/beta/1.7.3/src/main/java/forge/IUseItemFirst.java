 ...
 * to be invoked at the beginning of {@link Item#useOn(ItemStack, PlayerEntity, World, int, int, int, int)}.
 *
 * @author Eloraam
 * @since 1.0.0
 */
public interface IUseItemFirst {
	 ...
	 * When this returns {@code true}, {@link Item#useOn(ItemStack, PlayerEntity, World, int, int, int, int)}
