...
public class MinecraftForge {
	 ...
	 */
	@ApiStatus.Internal
	public static void populateBiome(World world, Biome biome, int chunkX, int chunkZ) {
	 ...
	 */
	@ApiStatus.Internal
	public static boolean canHarvestBlock(ToolItem tool, Block block) {
	...
	public static void addPickaxeBlockEffectiveAgainst(Block block) {
		((ForgeItemTool) Item.WOODEN_PICKAXE).addBlockEffectiveAgainst(block);
		((ForgeItemTool) Item.STONE_PICKAXE).addBlockEffectiveAgainst(block);
		((ForgeItemTool) Item.IRON_PICKAXE).addBlockEffectiveAgainst(block);
		((ForgeItemTool) Item.GOLDEN_PICKAXE).addBlockEffectiveAgainst(block);
		((ForgeItemTool) Item.DIAMOND_PICKAXE).addBlockEffectiveAgainst(block);
	}
